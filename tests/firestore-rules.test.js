...
test('sales may create a temporary product and own non-agency cost, but cannot alter existing master products', async () => {
  const product = { productId:'p3', status:'TEMPORARY', createdBy:'sales1', updatedBy:'sales1', authorizationType:'NON_AUTHORIZED', listPrice:0, nameEn:'Test product', specification:'10 tests' };
